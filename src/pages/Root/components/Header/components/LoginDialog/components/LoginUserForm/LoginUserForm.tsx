...
import {useLoginUserForm} from "./hooks/useLoginUserForm.ts";
...
const LoginUserForm = ({setIsOpen, register}: LoginUserFormProps) => {
    const { form, functions } = useLoginUserForm(setIsOpen);
