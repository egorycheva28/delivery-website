...
const EditDishDialog = ({ setIsOpen, isOpen, newDish, setNewDish }: NewOperatorDialogProps) => {
    const { state,
        form,
        functions } = useEditDishDialog(setIsOpen, isOpen, newDish, setNewDish);
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogContent className="sm:max-w-md">
                ...
                <Form {...form}>
                    <form onSubmit={functions.editDish} className='w-full space-y-4'>
