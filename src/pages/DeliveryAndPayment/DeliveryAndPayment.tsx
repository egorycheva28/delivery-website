...
const DeliveryAndPayment = () => {
    ...
    const restaurantLocation: [number, number] = [56.484640, 84.947649];
    const mapCenter: [number, number] = [56.484640, 84.947649];
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <section>
                ...
                <div className="flex items-center justify-center gap-8 flex-wrap">
                    <PaymentMethod cardOrCashIcon={<CreditCard className="h-10 w-10"/>}
                    ...
                    <PaymentMethod cardOrCashIcon={<Banknote className="h-10 w-10"/>}
                                   onlineOrOfflineIcon={<HandPlatter className="h-10 w-10"/>}
